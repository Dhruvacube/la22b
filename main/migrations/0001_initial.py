    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vote_nicknameassigntime_start', models.DateTimeField(verbose_name='Start Time limit of assigning votes and nickname')),
                ('vote_nicknameassigntime', models.DateTimeField(verbose_name='End Time limit of assigning votes and nickname')),
            ],
            options={
